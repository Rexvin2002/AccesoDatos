...
public class FileConverter {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 4) {
            System.out.println("""
                               Run the program from the command prompt by adding the arguments.
                               Usage: java Unidad01.Practica07.FileConverter <inputPath> <inputEncoding> <outputPath> <outputEncoding>""");
        ...
        if (!isValidEncoding(inputEncoding) || !isValidEncoding(outputEncoding)) {
            System.err.println("Invalid encoding. Supported encodings are: ASCII, UTF-8, UTF-16, ISO-8859-1");
        ...
        try {
            ...
            System.err.println("File converted successfully."); // Confirmar éxito
