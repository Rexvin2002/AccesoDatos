 ...
 */
public class SequentialFileReading2 {
    ...
    /**
     * Busca el texto proporcionado en todos los archivos del directorio y muestra la línea y columna de cada aparición.
     *
    ...
    /**
     * Busca el texto proporcionado en el archivo y muestra la línea y columna de cada aparición.
     *
    ...
    public static void searchTextInFile(File file, String searchText) {
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                while (columnIndex != -1) {
                    System.out.printf("Found in File: %s, Line: %d, Column: %d%n", file.getName(), lineNumber, columnIndex + 1);
