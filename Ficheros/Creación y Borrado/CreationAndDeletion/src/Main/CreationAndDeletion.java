...
/**
 * Esta clase permite crear una estructura de directorios y archivos, así como
 * eliminar archivos específicos solicitados por el usuario.
 */
public class CreationAndDeletion {

    /**
     * Método principal que ejecuta el programa. Crea la estructura de
     * directorios y permite al usuario borrar archivos.
     *
    ...
    /**
     * Crea una estructura de directorios y archivos representando una familia
     * ficticia. La estructura generada contiene directorios para "Abuelo",
     * "Abuela", y dentro de ellos, directorios para "Padre" y "Madre", además
     * de archivos de texto como hijos.
     */
    ...
    /**
     * Método que busca y elimina recursivamente un archivo específico dentro de
     * un directorio.
     *
     * @param dir El directorio donde comenzar la búsqueda.
     * @param fileNameToDelete El nombre del archivo que se desea eliminar.
     * @return true si el archivo fue eliminado exitosamente, false si no se
     * encontró o no se pudo eliminar.
     */
