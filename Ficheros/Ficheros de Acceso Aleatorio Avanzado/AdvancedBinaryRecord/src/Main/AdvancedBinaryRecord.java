...
/**
 * The AdvancedBinaryRecord class handles operations for reading and writing
 * records in a binary file. Each record consists of multiple fields of
 * specified lengths.
 */
public class AdvancedBinaryRecord {
    ...
    /**
     * Constructor to initialize the AdvancedBinaryRecord with a file path,
    ...
    public static void main(String[] args) {
        try {
            ...
            try {
                AdvancedBinaryRecord binaryRecord = new AdvancedBinaryRecord("src\\BinaryFiles\\binary_file_1.dat", fields, fieldLengths);
                                ...
                                try {
                                    ...
                                    if (!isEmpty) {
                                        ...
                                        if (confirm.equalsIgnoreCase("n")) {
                                            ...
                                            System.err.println("Invalid input. Please enter 'y' or 'n'."); // Handle invalid input.
                                            continue; // Prompt the user again for the position.
                                        }
                                    } else {
                                    ...
                                    System.err.println("Invalid input. Please enter a valid position or 'c' to cancel."); // Handle invalid input.
                                }
                            }
                        ...
                        case 2 -> {
                            ...
                            while (!validPosition) {
                                ...
                                try {
                                    ...
                                    System.err.println("Invalid input. Please enter a valid position or 'c' to cancel."); // Prompt for valid input.
                                }
                            }
                        ...
                        case 4 -> {
                            ...
                            while (!validInput) {
                                ...
                                try {
                                    ...
                                    if (recordNumber < 0) {
                                        System.err.println("Error: The record number must be a non-negative integer.");
                                    } else {
                                        ...
                                        if (record2 == null || record2.isEmpty()) {
                                            System.err.println("Error: No record found for record number " + recordNumber + ".");
                                        } else {
                                            ...
                                            while (!validColumnInput) {
                                                ...
                                                if (actualFieldName != null) {
                                                    ...
                                                    System.err.println("Error: No column found with the name '" + columnName + "'. Please try again.\n");
                                                }
                                            }
                                        }
                                    }
                                } catch (NumberFormatException e) {
                                    System.err.println("Error: Please enter a valid number for the record.");
                                }
                            }
                        ...
                        case 5 -> {
                            ...
                            while (!validInput) {
                                ...
                                try {
                                    ...
                                    System.err.println("Error: Please enter a valid record number.");
                                ...
                                while (true) {
                                    ...
                                    if (actualFieldName != null) {
                                        ...
                                        if (values != null && !values.isEmpty()) {
                                            ...
                                            System.err.println("Error: No values found for column '" + actualFieldName + "'. Please enter a valid column name.\n");
                                        }
                                    } else {
                                        System.err.println("Error: No column found with the name '" + columnName + "'. Please try again.\n");
                                    }
                            ...
                            while (true) {
                                ...
                                try {
                                    ...
                                    if (rowValues != null && !rowValues.isEmpty()) {
                                        ...
                                        System.err.println("No values found for record number " + recordNumber + ".");
                                    }
                                } catch (NumberFormatException e) {
                                    System.err.println("Error: Please enter a valid integer for the record number.\n");
                                }
                            }
                        }
                            ...
                            while (true) {
                                ...
                                try {
                                    ...
                                    if (rowMap != null && !rowMap.isEmpty()) { // Check if the map is not null and not empty
                                        ...
                                        System.err.println("No record found for number " + recordNumber + "."); // Message if the record is not found
                                    }
                                } catch (NumberFormatException e) {
                                    System.err.println("Invalid input. Please enter a valid record number or 'c' to cancel.");
                                }
                            }
                        }
                        // Update a record
                            ...
                            while (true) {
                                ...
                                try {
                                    ...
                                    if (existingRecord.isEmpty()) {
                                        System.err.println("No record found at the specified position.");
                                    ...
                                    if (updateChoice.equals("y")) {
                                        ...
                                        if (!fieldExists) {
                                            System.err.println("Field '" + fieldName + "' does not exist in the record. Please try again.");
                                        ...
                                        if (actualFieldName != null) {
                                            ...
                                            System.err.println("Failed to update the record due to field name mismatch.");
                                        }
                                    }
                                } catch (NumberFormatException e) {
                                    System.err.println("Invalid input. Please enter a valid record position or 'c' to cancel.");
                                }
                            }
