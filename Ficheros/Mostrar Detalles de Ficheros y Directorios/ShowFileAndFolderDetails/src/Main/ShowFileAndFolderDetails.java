...
/**
 * Esta clase permite mostrar detalles de archivos y directorios, listar los
 * contenidos de un directorio
 * y calcular el tamaño total de un directorio de manera recursiva.
 */
public class ShowFileAndFolderDetails {

    /**
     * Método principal que ejecuta el programa.
     * Solicita al usuario un path de archivo o directorio, muestra sus detalles y
     * lista los contenidos si es un directorio.
     *
     * @param args Argumentos de la línea de comandos, donde se puede pasar la ruta
     *             de archivo/directorio.
     */
    public static void main(String[] args) {
        while (true) {
            Scanner scanner = new Scanner(System.in);

            // Obtener la ruta desde los argumentos de la línea de comandos o preguntar al
            // usuario
     ...
     * Si se pasa un argumento en la línea de comandos, lo usa. De lo contrario,
    ...
    /**
     * Muestra los detalles de un archivo o directorio, como el tipo, nombre,
     * tamaño, permisos y fecha de última modificación.
     *
    ...
    public static void showDetails(File file) {
        ...
        if (file.isFile()) {
            ...
            System.out.printf("Tamaño: %d bytes (%.2f KB, %.2f MB)%n", sizeBytes, sizeBytes / 1024.0,
    ...
    /**
     * Lista los contenidos de un directorio, mostrando los detalles de cada archivo
     * o subdirectorio.
    ...
    /**
     * Calcula el tamaño total de un directorio recursivamente, sumando los tamaños
     * de todos los archivos y subdirectorios.
     *
